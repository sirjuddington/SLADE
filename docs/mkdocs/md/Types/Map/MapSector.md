...
<prop class="rw">planeFloor</prop> | <type>[Plane](../Plane.md)</type> | The floor plane of the sector
<prop class="rw">planeCeiling</prop> | <type>[Plane](../Plane.md)</type> | The ceiling plane of the sector

!!! note "UDMF plane properties"
    Setting <prop>planeFloor</prop> or <prop>planeCeiling</prop> from a script also updates the matching UDMF plane properties so authored slopes are saved with the map.
