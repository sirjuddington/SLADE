...
// Filename:    DiskArchiveHandler.cpp
// Description: ArchiveFormatHandler for Nerve DISK files
//
...
// -----------------------------------------------------------------------------
//
// DiskArchiveHandler Class Functions
//
// -----------------------------------------------------------------------------
...
bool DiskArchiveHandler::open(Archive& archive, const MemChunk& mc, bool detect_types)
{
	...
	for (uint32_t d = 0; d < num_entries; d++)
	{
		...
		{
			log::error("DiskArchiveHandler::open: Disk archive is invalid or corrupt (entry goes past end of file)");
		...
		auto dir = createDir(archive, fn.path());
...
// Returns true if successful, false otherwise
// -----------------------------------------------------------------------------
bool DiskArchiveHandler::write(Archive& archive, MemChunk& mc)
{
	// Clear current data
	mc.clear();
...
// -----------------------------------------------------------------------------
//
// DiskArchiveHandler Class Static Functions
//
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
bool DiskArchiveHandler::isThisFormat(const MemChunk& mc)
{
	// Check given data is valid
	size_t mcsize = mc.size();
	if (mcsize < 80)
