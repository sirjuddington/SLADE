	...
	for (unsigned a = 0; a < binds.size(); a++)
	{
		...
		else if (name == "ted_findnext")
		{
			if (panel_fr_ && panel_fr_->IsShown())
				findNext(panel_fr_->getFindText(), panel_fr_->getFindFlags());
		...
		{
			if (panel_fr_ && panel_fr_->IsShown())
				findPrev(panel_fr_->getFindText(), panel_fr_->getFindFlags());
		...
		{
			if (panel_fr_ && panel_fr_->IsShown())
				replaceCurrent(panel_fr_->getFindText(), panel_fr_->getReplaceText(), panel_fr_->getFindFlags());
		...
		{
			if (panel_fr_ && panel_fr_->IsShown())
				replaceAll(panel_fr_->getFindText(), panel_fr_->getReplaceText(), panel_fr_->getFindFlags());
