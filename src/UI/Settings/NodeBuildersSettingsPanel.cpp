...
// -----------------------------------------------------------------------------
//
// NodeBuildersSettingsPanel Class Functions
//
// -----------------------------------------------------------------------------


// -----------------------------------------------------------------------------
// NodeBuildersSettingsPanel class constructor
// -----------------------------------------------------------------------------
NodeBuildersSettingsPanel::NodeBuildersSettingsPanel(wxWindow* parent) : SettingsPanel(parent)
{
	// Create sizer
	...
	btn_browse_path_->Bind(wxEVT_BUTTON, &NodeBuildersSettingsPanel::onBtnBrowse, this);
...
// node builder
// -----------------------------------------------------------------------------
void NodeBuildersSettingsPanel::populateOptions(const wxString& options) const
{
	// Get current builder
	auto& builder = nodebuilders::builder(choice_nodebuilder_->GetSelection());
...
// -----------------------------------------------------------------------------
//
// NodeBuildersSettingsPanel Class Events
//
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
void NodeBuildersSettingsPanel::onBtnBrowse(wxCommandEvent& e)
{
	auto& builder = nodebuilders::builder(choice_nodebuilder_->GetSelection());
