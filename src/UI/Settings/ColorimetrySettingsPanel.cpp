...
// Filename:    ColorimetrySettingsPanel.cpp
// Description: Panel containing colorimetry settings controls
//
...
// -----------------------------------------------------------------------------
//
// ColorimetrySettingsPanel Class Functions
//
// -----------------------------------------------------------------------------
...
ColorimetrySettingsPanel::ColorimetrySettingsPanel(wxWindow* parent) : SettingsPanel(parent)
{
	...
	// Bind events
	choice_presets_grey_->Bind(wxEVT_CHOICE, &ColorimetrySettingsPanel::onChoiceGreyscalePresetSelected, this);
	choice_colmatch_->Bind(wxEVT_CHOICE, [&](wxCommandEvent&) { col_match = 1 + choice_colmatch_->GetSelection(); });
	choice_presets_tristim_->Bind(wxEVT_CHOICE, &ColorimetrySettingsPanel::onChoiceTristimPresetSelected, this);
}
...
// -----------------------------------------------------------------------------
void ColorimetrySettingsPanel::onChoiceGreyscalePresetSelected(wxCommandEvent& e)
{
...
// -----------------------------------------------------------------------------
void ColorimetrySettingsPanel::onChoiceTristimPresetSelected(wxCommandEvent& e)
{
