...
// Filename:    TextEditorStylePanel.cpp
...
// -----------------------------------------------------------------------------
//
// TextEditorStylePanel Class Functions
//
// -----------------------------------------------------------------------------


// -----------------------------------------------------------------------------
// TextEditorStylePanel class constructor
// -----------------------------------------------------------------------------
TextEditorStylePanel::TextEditorStylePanel(wxWindow* parent) :
	wxPanel{ parent },
	...
	language_preview_{ new TextLanguage("preview") }
{
	...
	// Bind events
	list_styles_->Bind(wxEVT_LISTBOX, &TextEditorStylePanel::onStyleSelected, this);
	cb_override_font_face_->Bind(wxEVT_CHECKBOX, &TextEditorStylePanel::onCBOverrideFontFace, this);
	cb_override_font_size_->Bind(wxEVT_CHECKBOX, &TextEditorStylePanel::onCBOverrideFontSize, this);
	cb_override_font_bold_->Bind(wxEVT_CHECKBOX, &TextEditorStylePanel::onCBOverrideFontBold, this);
	cb_override_font_italic_->Bind(wxEVT_CHECKBOX, &TextEditorStylePanel::onCBOverrideFontItalic, this);
	cb_override_font_underlined_->Bind(wxEVT_CHECKBOX, &TextEditorStylePanel::onCBOverrideFontUnderlined, this);
	cb_override_foreground_->Bind(wxEVT_CHECKBOX, &TextEditorStylePanel::onCBOverrideForeground, this);
	cb_override_background_->Bind(wxEVT_CHECKBOX, &TextEditorStylePanel::onCBOverrideBackground, this);
	fp_font_->Bind(wxEVT_FONTPICKER_CHANGED, &TextEditorStylePanel::onFontChanged, this);
	cp_foreground_->Bind(wxEVT_COLOURPICKER_CHANGED, &TextEditorStylePanel::onForegroundChanged, this);
	cp_background_->Bind(wxEVT_COLOURPICKER_CHANGED, &TextEditorStylePanel::onBackgroundChanged, this);
	btn_savestyleset_->Bind(wxEVT_BUTTON, &TextEditorStylePanel::onBtnSaveStyleSet, this);
	choice_styleset_->Bind(wxEVT_CHOICE, &TextEditorStylePanel::onStyleSetSelected, this);
	cb_font_override_->Bind(wxEVT_CHECKBOX, &TextEditorStylePanel::onCBOverrideFont, this);
	fp_font_override_->Bind(wxEVT_FONTPICKER_CHANGED, &TextEditorStylePanel::onFontOverrideChanged, this);
...
// -----------------------------------------------------------------------------
wxPanel* TextEditorStylePanel::createStylePanel()
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::init()
{
	te_preview_->SetText(
		"#include \"include.txt\"\n"
		"\n"
...
// the list
// -----------------------------------------------------------------------------
void TextEditorStylePanel::updateStyleControls() const
{
	if (!ts_current_)
		return;
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::updateFontFace() const
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::updateFontSize() const
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::updateFontBold() const
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::updateFontItalic() const
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::updateFontUnderlined() const
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::updateForeground() const
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::updateBackground() const
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::updatePreview() const
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::apply() const
{
	if (cb_font_override_->GetValue())
	{
		txed_override_font      = wxutil::strToView(fp_font_override_->GetSelectedFont().GetFaceName());
...
// -----------------------------------------------------------------------------
//
// TextEditorStylePanel Class Events
//
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onStyleSelected(wxCommandEvent& e)
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onCBOverrideFontFace(wxCommandEvent& e)
{
	updateFontFace();
	updatePreview();
}
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onCBOverrideFontSize(wxCommandEvent& e)
{
	updateFontSize();
	updatePreview();
}
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onCBOverrideFontBold(wxCommandEvent& e)
{
	updateFontBold();
	updatePreview();
}
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onCBOverrideFontItalic(wxCommandEvent& e)
{
	updateFontItalic();
	updatePreview();
}
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onCBOverrideFontUnderlined(wxCommandEvent& e)
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onCBOverrideForeground(wxCommandEvent& e)
{
	updateForeground();
	updatePreview();
}
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onCBOverrideBackground(wxCommandEvent& e)
{
	updateBackground();
	updatePreview();
}
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onFontChanged(wxFontPickerEvent& e)
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onForegroundChanged(wxColourPickerEvent& e)
{
	updateForeground();
	updatePreview();
}
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onBackgroundChanged(wxColourPickerEvent& e)
{
	updateBackground();
	updatePreview();
}
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onBtnSaveStyleSet(wxCommandEvent& e)
{
	// Get name for set
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onStyleSetSelected(wxCommandEvent& e)
{
	if (init_done_)
	{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onCBOverrideFont(wxCommandEvent& e)
{
...
// -----------------------------------------------------------------------------
void TextEditorStylePanel::onFontOverrideChanged(wxFontPickerEvent& e)
{
	updatePreview();
}
