...
// Filename:    InputSettingsPanel.cpp
...
// -----------------------------------------------------------------------------
//
// InputSettingsPanel Class Functions
//
// -----------------------------------------------------------------------------


// -----------------------------------------------------------------------------
// InputSettingsPanel class constructor
// -----------------------------------------------------------------------------
InputSettingsPanel::InputSettingsPanel(wxWindow* parent) : SettingsPanel(parent)
{
	...
	// Bind events
	list_binds_->Bind(wxEVT_TREELIST_SELECTION_CHANGED, &InputSettingsPanel::onListSelectionChanged, this);
	list_binds_->Bind(wxEVT_TREELIST_ITEM_ACTIVATED, &InputSettingsPanel::onListItemActivated, this);
	btn_change_->Bind(wxEVT_BUTTON, &InputSettingsPanel::onBtnChangeKey, this);
	...
	btn_defaults_->Bind(wxEVT_BUTTON, &InputSettingsPanel::onBtnDefaults, this);
...
// -----------------------------------------------------------------------------
void InputSettingsPanel::initBindsList() const
{
...
// -----------------------------------------------------------------------------
void InputSettingsPanel::updateBindsList() const
{
	// Get first list item
...
// -----------------------------------------------------------------------------
void InputSettingsPanel::changeKey(wxTreeListItem item)
{
...
// -----------------------------------------------------------------------------
void InputSettingsPanel::addKey()
{
	// Get selected item
...
// -----------------------------------------------------------------------------
void InputSettingsPanel::removeKey(wxTreeListItem item) const
{
	// Get item keybind info
	auto bind = dynamic_cast<BindListItemData*>(list_binds_->GetItemData(item));
...
// -----------------------------------------------------------------------------
void InputSettingsPanel::applySettings()
{
	// Go through all list items
	auto item = list_binds_->GetFirstItem();
	while (item.IsOk())
...
// -----------------------------------------------------------------------------
//
// InputSettingsPanel Class Events
//
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
void InputSettingsPanel::onSize(wxSizeEvent& e)
{
...
// -----------------------------------------------------------------------------
void InputSettingsPanel::onListSelectionChanged(wxTreeListEvent& e)
{
	// Get selected item
	auto item = e.GetItem();
...
// -----------------------------------------------------------------------------
void InputSettingsPanel::onListItemActivated(wxTreeListEvent& e)
{
	// Get selected item
	auto item = list_binds_->GetSelection();
...
// -----------------------------------------------------------------------------
void InputSettingsPanel::onBtnChangeKey(wxCommandEvent& e)
{
	// Get selected item
	auto item = list_binds_->GetSelection();
...
// -----------------------------------------------------------------------------
void InputSettingsPanel::onBtnDefaults(wxCommandEvent& e)
{
	// Get selected item
	auto item = list_binds_->GetSelection();
	auto bind = dynamic_cast<BindListItemData*>(list_binds_->GetItemData(item));
...
// -----------------------------------------------------------------------------
void InputSettingsPanel::onListKeyDown(wxKeyEvent& e)
{
