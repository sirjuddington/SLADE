...
{
	Bind(wxEVT_PAINT, [&](wxPaintEvent&) { wxPaintDC dc(this); render(); });
...
void GLCanvas::drawContent()
{
	...
	glVertex2i(0, height); glVertex2i(0, 0);
	glVertex2i(0, 0); glVertex2i(width, height);
	glVertex2i(width, 0); glVertex2i(0, height);
	glEnd();
