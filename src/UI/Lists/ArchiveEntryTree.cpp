...
// -----------------------------------------------------------------------------
bool ArchiveViewModel::entryIsInList(const ArchiveEntry& entry, bool filter) const
{
...
// -----------------------------------------------------------------------------
bool ArchiveViewModel::dirIsInList(const ArchiveDir& dir, bool filter) const
{
