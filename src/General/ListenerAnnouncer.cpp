...
// -----------------------------------------------------------------------------
void Listener::onAnnouncement(Announcer* announcer, string_view event_name, MemChunk& event_data) {}
...
// -----------------------------------------------------------------------------
void Announcer::announce(string_view event_name, MemChunk& event_data)
{
	if (isMuted())
		return;
...
// -----------------------------------------------------------------------------
void Announcer::announce(string_view event_name)
{
	MemChunk mc;
