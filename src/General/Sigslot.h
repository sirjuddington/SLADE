...
// Simple struct containing an array of scoped signal connections, so classes
// that connect to many different signals don't need to keep a separate
// scoped_connection member variable for each one.
