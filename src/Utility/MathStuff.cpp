...
{
	// Rewritten to be simpler by Talon1024, based on the implementation in:
	// https://github.com/pineapplemachine/jsdoom/blob/8bf18cc7921af0dd1994eb55155b22779b2a874e/src/convert/3DMapBuilder.ts#L164
	// Assume p2 is the "center" point, and that the angle to calculate is
	// counterclockwise.
