 ...
 * VARIABLES
 *******************************************************************/
const string TokenizerOld::DEFAULT_SPECIAL_CHARS = ";,:|={}/";
 ...
 *******************************************************************/
TokenizerOld::TokenizerOld(CommentTypes comments_style)
{
...
*******************************************************************/
void TokenizerOld::setSpecialCharacters(string special_new)
{
	this->special.clear();
 ...
 *******************************************************************/
bool TokenizerOld::openFile(string filename, uint32_t offset, uint32_t length)
{
	// Open the file
 ...
 *******************************************************************/
bool TokenizerOld::openString(const string& text, uint32_t offset, uint32_t length, string source)
{
 ...
 *******************************************************************/
bool TokenizerOld::openMem(const char* mem, uint32_t length, string source)
{
 ...
 * Reads a chunk of memory to the Tokenizer
 *******************************************************************/
bool TokenizerOld::openMem(const uint8_t* mem, uint32_t length, string source)
{
	// Length must be specified
	if (length == 0)
	{
 ...
 * Reads a chunk of memory to the Tokenizer
 *******************************************************************/
bool TokenizerOld::openMem(MemChunk* mem, string source)
{
	// Needs to be valid
	if (mem == NULL)
	{
 ...
 *******************************************************************/
bool TokenizerOld::isWhitespace(char p)
{
 ...
 *******************************************************************/
bool TokenizerOld::isSpecialCharacter(char p)
{
 ...
 *******************************************************************/
bool TokenizerOld::incrementCurrent()
{
	if (position >= size - 1)
	{
 ...
 * Skips a '//' comment
 *******************************************************************/
void TokenizerOld::skipLineComment()
{
	if (atEnd())
		return;
 ...
 *******************************************************************/
void TokenizerOld::skipMultilineComment()
{
	if (atEnd())
		return;
 ...
 *******************************************************************/
void TokenizerOld::readToken(bool toeol)
{
	token_current.clear();
	bool ready = false;
	qstring = false;
 ...
 * the result to [s]
 *******************************************************************/
void TokenizerOld::getToken(string* s)
{
	// Read token
	readToken();
 ...
 *******************************************************************/
bool TokenizerOld::checkToken(string check)
{
	readToken();
 ...
 *******************************************************************/
void TokenizerOld::getInteger(int* i)
{
	// Read token
	readToken();
 ...
 *******************************************************************/
void TokenizerOld::getFloat(float* f)
{
	// Read token
	readToken();
 ...
 *******************************************************************/
void TokenizerOld::getDouble(double* d)
{
	// Read token
	readToken();
 ...
 * getBool above
 *******************************************************************/
void TokenizerOld::getBool(bool* b)
{
	// Read token
	readToken();
 ...
 *******************************************************************/
void TokenizerOld::getTokensUntil(vector<string>& tokens, string end)
{
	while (1)
	{
		readToken();
 ...
 *******************************************************************/
void TokenizerOld::skipSection(string open, string close)
{
	int level = 0;
	readToken();
